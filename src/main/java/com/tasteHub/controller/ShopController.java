...
public class ShopController {
     ...
     */
    @GetMapping("/{id}")
    @ApiOperationLog(description = "查询商铺详情")
     ...
     */
    @PostMapping
    @ApiOperationLog(description = "新增商铺")
     ...
     */
    @PutMapping
    @ApiOperationLog(description = "更新商铺")
     ...
     */
    @GetMapping("/of/type")
    @ApiOperationLog(description = "根据商铺类型查询商铺")
     ...
     */
    @GetMapping("/of/name")
    @ApiOperationLog(description = "根据商铺名称查询商铺")
